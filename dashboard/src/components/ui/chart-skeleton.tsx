...
export function ChartSkeleton({
  ...
  return (
    <div
      role="status"
      aria-live="polite"
      className={cn("relative overflow-hidden rounded-xl bg-muted/15", className)}
      style={{ height }}
    >
      ...
      <svg
        ...
        className="absolute inset-x-3 inset-y-6 h-[calc(100%-3rem)] w-[calc(100%-1.5rem)] text-muted-foreground/20"
      >
        <path
