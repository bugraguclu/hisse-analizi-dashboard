...
export interface KapItem {
  ...
  // Optional DB-only extras (older backends and the live KAP feed omit them).
  /** KAP "Özet" line when it adds information beyond the title. */
  summary?: string | null;
  /** EventCategory name (DIVIDEND, LEGAL, …). */
  categoryCode?: string | null;
  /** Tracked companies this disclosure concerns (> 1 for collective notices). */
  tickerCount?: number | null;
  /** A corrected ("düzeltme") disclosure. */
