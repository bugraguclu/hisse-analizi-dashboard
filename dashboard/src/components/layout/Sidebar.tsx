...
const navItems = [
  ...
  { href: "/events", labelKey: "nav.events", icon: Newspaper },
  { href: "/hisse/THYAO", labelKey: "nav.stockAnalysis", icon: BarChart3, match: "/hisse" },
  { href: "/analiz/THYAO", labelKey: "nav.combinedAnalysis", icon: Columns2, match: "/analiz" },
  { href: "/makro", labelKey: "nav.macroEconomy", icon: Globe },
  { href: "/tarama", labelKey: "nav.screening", icon: Search },
] satisfies Array<{ href: string; labelKey: TranslationKey; icon: typeof LayoutDashboard; match?: string }>;
      ...
      <SidebarBody className="justify-between gap-8">
        ...
        <div className="pt-4 border-t border-sidebar-border/40">
          <a
            ...
            aria-label="API dokümantasyonunu aç"
...
const Logo = () => {
  return (
    <Link
      href="/"
      aria-label="Hisse Analizi ana sayfa"
    ...
    >
      ...
      >
        ...
        <span className="text-[10px] text-muted-foreground font-mono leading-tight">v0.8.0 BIST Dashboard</span>
      </motion.div>
    </Link>
  );
};
