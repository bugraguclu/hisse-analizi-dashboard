...
export function LatestEvents() {
  ...
  if (events.length === 0) return <EmptyState message="Henüz olay kaydedilmemiş" />;
      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="bg-muted/50 text-left">
            ...
            <th className="px-4 py-2.5 text-[11px] font-semibold text-muted-foreground uppercase tracking-wide">Başlık</th>
            <th className="px-4 py-2.5 text-[11px] font-semibold text-muted-foreground uppercase tracking-wide">Kategori</th>
            <th className="px-4 py-2.5 text-[11px] font-semibold text-muted-foreground uppercase tracking-wide">Önem</th>
          </tr>
        </thead>
