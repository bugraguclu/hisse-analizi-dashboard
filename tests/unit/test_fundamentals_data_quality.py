...
def test_snapshot_pb_uses_the_latest_quarter_book_value():
    # price_book_ratio divides by the last annual equity (THYAO 0,45 on 2026-09-23);
    # price_book_fq by the latest quarter's, like İş Yatırım and the screener (0,40).
    row = {"close": 298.5, "change_abs": 0.5, "market_cap_basic": 411_240_000_000,
           "price_book_ratio": 0.4499, "price_book_fq": 0.4022}

    snap = f._snapshot_from_scan(row, {})

    assert snap["pb_ratio"] == 0.4
