...
def test_growth_from_a_loss_or_zero_base_is_not_reported():
    ...
    assert ratios_math.compute_financial_ratios(current, previous={"net_income_parent": -3_215.0})["net_income_growth_yoy"] is None
    assert ratios_math.compute_financial_ratios(current, previous={"net_income_parent": 0.0})["net_income_growth_yoy"] is None
    assert ratios_math.compute_financial_ratios(current, previous={"net_income_parent": 30_000.0})["net_income_growth_yoy"] == 13.57
